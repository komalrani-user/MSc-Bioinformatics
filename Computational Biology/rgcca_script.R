...
library(ggplot2)
library(plotly)
source('/rds/homes/k/kxr353/cazierj-msc-bioinf/kxr353/computational_biology/fileio.R')


# load RNA-seq data
rna.ds <- load.dataset(
  meta.file = '/rds/homes/k/kxr353/cazierj-msc-bioinf/kxr353/computational_biology/sample_sheet.csv', meta.sep = ',',
  data.file = '/rds/homes/k/kxr353/cazierj-msc-bioinf/kxr353/computational_biology/rna_norm_counts.csv', data.sep = ','
)
...
polar.ds <- load.dataset(
  meta.file = '/rds/homes/k/kxr353/cazierj-msc-bioinf/kxr353/computational_biology/sample_sheet.csv', meta.sep = ',',
  data.file = '/rds/homes/k/kxr353/cazierj-msc-bioinf/kxr353/computational_biology/polar_pos_pqn_imputed_glog.csv', data.sep = ','
)
